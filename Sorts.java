...
public class Sorts {
    ...
    public Sorts(int size, String sorter) {
        ...
        switch (sorter) {
            case "bubble sorter" -> bubbleSort(data);
            case "insert sorter" -> insertionSort(data);
            case "merge sorter" -> mergeSort(data);
        }

        Instant end = Instant.now();    // time capture -- end
        this.timePassed = Duration.between(start, end);
    }
    ...
    public static void main(String[] args) {
        ...
        for (String option : options) {
            ...
            for (int i = 0; i < TIMES; i++) {
                ...
                System.out.println("Nanoseconds: " + s.getTimePassed());
                time += s.getTimePassed();
            }
            System.out.println("--------------------------------------");
